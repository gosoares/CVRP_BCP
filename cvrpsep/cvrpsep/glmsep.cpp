...
{
  long long i,j,k,DepotIdx;
  long long GraphNodes,ArcCap,CapFromSource,MaxFlowValue;
  double XVal,XijFactor,ScaleFactor,WeightedSum;
  double SGi, SGj, SGk, BG;
  long long *SourceNodeList;
  double *DepotEdgeXVal;
  long long SourceNodeListSize;
  MaxFlowPtr MXFPtr;  
  ScaleFactor = 1000.0;
  BG = BigGamma;
