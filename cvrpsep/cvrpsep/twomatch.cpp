...
{
  long long j,k;
  long long Node,ReachedNr,ReachedListSize;
...
void TWOMATCH_CheckConnectedHandle(ReachPtr SupportPtr,
                                   long long NoOfCustomers,
                                   long long *HandleList,
                                   long long HandleListSize,
                                   char *Connected)
{
  long long i,j,k,Node;
  long long ReachedNr,ReachedListSize;
  char *InHandle, *Reached;
  long long *ReachedList;
                                ...
                                CnstrMgrPointer CutsCMP)
{
  ...
  char HandleOK;
  long long i,j,k,Tail,Head;
  long long NoOfNewNodes,NewNodeNr,FlowEdgesUB;
  long long HandleSize;
  long long TSize;
  long long OriginalNodes,TotalNodes;
  double XVal,Scale,RHS;
  long long ArcCap,MaxArcCap;
  long long NodeListSize;
  long long IntListSize, ExtListSize;
  char *OddNode, *OnHandleSide, *InTooth;
  long long *NewNodeTail, *NewNodeHead;
  long long *CutValue, *NextOnPath;
  long long *NodeList;
