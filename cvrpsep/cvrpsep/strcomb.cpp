...
void STRCOMB_ComputeStrCombRHS(long long NoOfCustomers,
                               long long NoOfTeeth,
                               long long *Demand,
                               long long CAP,
                               long long *IntList,
...
void STRCOMB_ExpandTooth(ReachPtr SupportPtr,
                         ...
                         double **XMatrix,
                         ReachPtr ToothRPtr,
                         long long *ParamBestList,
                         long long *ParamBestListSize,
                         double *LHS,
                         long long *RHS)
{
  ...
  long long i,j,k,t;
  long long TotalDemand;
  long long NodeListSize,BestNodeListSize,InitNodeListSize,BestNode,BestXNode;
  long long Stage /*,BestStage*/;
  double XVal,BestX,ToothDelta,Slack,BestSlack;
  double NewToothDelta,NewSlack,NewBestSlack;
  char *Reached, *Selectable, *InSet;
  char *TouchedTooth;
  long long *Q, *QCalc, *QCap, *QK;
  long long *NewQ, *NewQCalc, *NewQCap, *NewQK;
  long long *NodeStage, *NodeList;
  double *XValue;
                                ...
                                long long *RHS)
{
  ...
  double LocalLHS;
  long long i,j,k,t;
  long long ListSize, BestListSize;
  double Slack,BestSlack;
  long long *List, *BestList;
...
void STRCOMB_GenerateHandlesV2(ReachPtr SupportPtr,
                               ...
                               long long MaxNoOfHandles,
                               long long *FoundNoOfHandles)
{
  char ListFound;
  char TailInBlock,HeadInBlock;
  long long i,j,k,Idx,EdgeNr,Tail,Head,Label,NodeSum;
  long long TailComp,HeadComp;
  long long BlockNr;
  long long NoOfEdges,NoOfBlocks,NoOfHandles,NodeListSize;
  double XVal;
  long long *EdgeHead, *EdgeTail, *NodeList;
  long long *Index;
  long long *NodeLabel;
  double *Value;
  long long *CompNr;
...
void STRCOMB_Shrink(ReachPtr SupportPtr,
                    ...
                    char UseDepotMatch,
                    double **XMatrix,
                    long long *CompNr, /* Node j is in component nr. CompNr[j]. */
                    long long *CompDemand,
                    double *CompBoundary,
                    double **SMatrix,
                    ReachPtr ResultCompsRPtr,
                    long long *ResultNoOfComponents)
{
  char ShrinkAgain;
  long long i,j,k,Idx;
  long long NoOfComponents,DepotCompNr;
  long long CompI,CompJ,CompK;
  double XVal,EdgeSum;
...
void STRCOMB_MainStrengthenedCombs(ReachPtr SupportPtr, /* Original graph */
                                   long long NoOfCustomers,
                                   long long CAP,
                                   long long *Demand, /* Original demand */
                                   long long QMin,
                                   double **XMatrix,
                                   ...
                                   CnstrMgrPointer CutsCMP)
{
  ...
  long long i,j,k,t,Idx,HIdx;
  long long MaxNoOfHandles,NoOfHandles,HandleNr,NoOfTeeth,MaxNoOfTeeth;
  long long NoOfComponents,NoOfSuperNodes;
  long long SuperNode;
  long long NoOfEdges,EdgeNr;
  long long HListSize;
  long long Head,Tail;
  long long ToothRHS,RHSSum,RHS;
  long long IntListSize, ExtListSize;
  long long NodeListSize;
  long long GeneratedCombs;
  long long DemandSum;
  long long MinVehicles;
  double ToothLHS,LHSSum,LHS;
  double XVal,XSum,HBoundary,ToothSurplus,ToothSurplusSum;

  char *InHandle;
  char *DepotEdgeBound;
  long long *EdgeHead, *EdgeTail, *ToothHead, *ToothTail;
  long long *HList, *TList;
  long long *Index;
  long long *IntList, *ExtList;
  long long *NodeList;
  long long *CompNr;
