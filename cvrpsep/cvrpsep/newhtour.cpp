...
long long GlobalHTours = 0;
long long MaxGlobalHTours = 100;

void NEWHTOUR_CheckIfHandleExists(ReachPtr RPtr,
                                  long long RPtrSize, /* #lists in RPtr */
                                  long long *HList,
                                  long long HListSize,
                                  char *Exists)
{
  long long i,j;
  long long *SortedList;
...
{
  long long i,j,Tmp;
  long long LabeledListSize,PermanentLabels;
  long long Seed,BestPos,BestLabel,NewLabel;
  char *Labeled;
  long long *LabeledList, *Label;
...
{
  long long i,j,k,Idx;
  long long NoOfEdges,BlocksCount;
  long long ListSize,AdjListSize;
  long long *NodeInIndex, *IndexForNode;
  long long *AdjList;
  ReachPtr RPtr;
  ReachPtr BlocksRPtr;
...
void NEWHTOUR_CheckBlocks(ReachPtr SupportPtr,
                          ...
                          long long *NoOfEliminatedSets,
                          ReachPtr EliminatedSetsRPtr)
{
  long long i,j,k,LoopNr,Origin,Seed,BlockNr,BlockSize;
  long long ArtPoint;
  long long MaxDemandOnPath;
  long long EdgeIdx,EdgesOnPath;
  long long NodeListSize;
  long long LabeledListSize,PermanentLabels;
  long long NewLabel,BestPos,BestLabel;
  long long Tmp;
  long long NoOfBlocks;
  double XSum;
  char *NodeInGraph;
  char *Labeled;
  long long *LabeledList, *Label;
  long long *TailOnPath, *HeadOnPath, *BlockOnPath;
  long long *NodeList;
  char **InBlock;
...
void NEWHTOUR_CheckPathsIntersection(long long NoOfCustomers,
                                     long long Head1,
                                     long long Head2,
                                     long long *NextOnPath,
                                     char *Intersecting)
...
void NEWHTOUR_ComputeCompletingSet(ReachPtr SupportPtr,
                                   ...
                                   char **EdgeInF)
{
  long long i,j,IdxI,LoopNr,Origin,Seed;
  long long MaxDemandOnPath;
  long long FirstHead,SecondHead;
  long long LabeledListSize,PermanentLabels;
  long long NewLabel,BestPos,BestLabel;
  long long Tmp;
  char *Labeled;
  long long *LabeledList, *Label;
  long long *QToDepot, *NextOnPath;
                              ...
                              double *MaxViolation)
{
  ...
  long long i,j,k,IdxI,IdxJ;
  long long NoOfSpecialPairs,DimSpecialPairs,SpecialPairNr;
  long long NoOfEliminatedSets;
  long long MinEdgeTail,MinEdgeHead;
  long long Head1,Head2;
  long long PairQSum;
  long long SetNr,NodeListSize;
  long long CutListSize;
  long long GeneratedCuts;
  double XVal,ViolationUB,DeletedSum,MinEdgeOnPaths;
  double LHS,RHS;
  char *CustInSet;
  long long *Mate, *SpecialH1, *SpecialH2, *QToDepot, *NextOnPath, *NodeList;
  ...
  for (IdxI=1; IdxI<HListSize; IdxI++)
  {
    ...
    for (IdxJ=IdxI+1; IdxJ<=HListSize; IdxJ++)
    {
      ...
      if (ViolationUB >= 0.02)
      {
        ...
        {
          DimSpecialPairs *= 2;
          SpecialH1 = (long long *) MemReGet(SpecialH1,
                                         sizeof(long long)*(DimSpecialPairs+1));
          SpecialH2 = (long long *) MemReGet(SpecialH2,
                                         sizeof(long long)*(DimSpecialPairs+1));
...
void NEWHTOUR_ComputeHTours(ReachPtr SupportPtr,
                            ...
                            CnstrMgrPointer CutsCMP,
                            long long MaxHTourCuts,
                            double *MaxHTourViolation)
{
  char HandleExists;
  long long i,j,k;
  long long Index,SeedNr,SuperSetSize,AddedSuperNode,RemovedSuperNode,DemandSum;
  long long CustNr,NoOfRemovedCusts;
  long long CustListSize;
  long long TotalDemand,TotalNoOfEdges;
  long long PreviousHandleNr;
  long long CutsBefore,CutsAfter;
  double SBoundary;
  ...
  long long CutListSize;
  long long *TailList, *HeadList;
  double *CoeffList;

  INTAPPtr AP;

  long long NoOfRoundsForSets;
