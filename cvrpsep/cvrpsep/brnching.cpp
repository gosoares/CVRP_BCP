...
void BRNCHING_GenerateCandidateSets(ReachPtr SupportPtr,
                                    ...
                                    long long MaxNoOfCustSets,
                                    char DivideByDemand,
                                    ReachPtr *CustSetsRPtr,
                                    long long *NoOfCustSets,
                                    double *CustSetBoundary)
{
  long long i,j,k,Idx,IdxTail,IdxHead,Tail,Head;
  long long MaxSuperNodesInSet,ListDemandSum;
  long long NoOfV1Cuts,ShrunkGraphCustNodes;
  long long MaxTotalSets,NoOfCandidateSets;
  long long TotalEdges;
  long long CandidateDemandSum;
  double XVal,XSum;

  long long *SuperDemand, *SortedSuperDemand, *CandidateDemand;
  double *SetBoundary, *CandidateBoundary;

  long long *CustList;
  long long CustListSize,CustNr;

  long long CandidateSetNr;
...
void BRNCHING_GetCandidateSets(long long NoOfCustomers,
                               long long *Demand,
                               long long CAP,
                               long long NoOfEdges,
                               long long *EdgeTail,
                               ...
                               CnstrMgrPointer CMPExistingCuts,
                               double BoundaryTarget,
                               long long MaxNoOfSets,
                               char DivideByDemand,
                               CnstrMgrPointer SetsCMP)
{
  long long i,j,SetNr,NoOfSets;
  double *SetBoundary;
  double **XMatrix;
  double **SMatrix;
  ReachPtr SupportPtr;
